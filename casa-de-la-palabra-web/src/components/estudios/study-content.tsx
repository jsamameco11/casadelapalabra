...
// Un bloque de contenido. El editor eligió el tipo y los datos; acá solo se
// decide cómo se ve. Todo campo es opcional a propósito: un versículo sin
// reflexión, una imagen sin pie o un texto sin título deben verse bien.
...
function VerseBlock({ content, bookNames }: { content: StudyContent; bookNames: Record<string, string> }) {
  ...
  const body = (
    <div className={immersive ? "relative bg-black/55 p-10 text-white" : side ? "p-8 sm:flex-1" : ""}>
      ...
      {/* La reflexión es opcional: sin ella no queda ningún hueco. */}
